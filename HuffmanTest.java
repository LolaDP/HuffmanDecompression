...
public class HuffmanTest {
	...
	public static void main (String[] arg) {
		...
		System.out.println("the sequence of bits corresponding to the compressed test is : "+file.toByteArray());
		
////TO DISPLAY THE UNCOMPRESSED TEXT WITH treePathBis()
//		String a="";
//		int i=0;
//		ArrayList<String> l= new ArrayList<String>();
//		while (i<file.toByteArray().length()-1) {
//			l=file.treePathBis(file.toByteArray(),tree.treeCreation(),i);
//			a=a+l.get(0);
...
//		System.out.println("the unzipped text is : "+a);
		...
		System.out.println("the unzipped text is : "+file.treePath(file.toByteArray(), root));
		//storing unzipped text
		String txtDecomp=file.treePath(file.toByteArray(), root);
