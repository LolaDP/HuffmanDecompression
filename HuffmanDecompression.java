...
public class HuffmanDecompression {
	...
	public ArrayList<String> treePathBis(String txtByte, HuffmanNode node, int i) {
		//same goal as treePath () using recursive, only return a list with one character and i (requires while loop in Test to get all characters)
		String txt="";
	...
	public float compression_rateBis(HuffmanNode root) {
	    ...
	    //calculation of the initial volume (unzipped txt)
		String unzipTxt=treePath(toBitString(), root);
